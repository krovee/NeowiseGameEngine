...
namespace Neowise {
    ...
    NW_API TReal 	dot(const FVector2& x, const FVector2& y);
    ...
    NW_API FVector2 mix(const FVector2& x, const FVector2& y, TReal t);
    ...
    NW_API TReal 	dot(const FVector3& x, const FVector3& y);
    ...
    NW_API FVector3 mix(const FVector3& x, const FVector3& y, TReal t);
    ...
    NW_API TReal 	dot(const FVector4& x, const FVector4& y);
    ...
    NW_API FVector4 mix(const FVector4& x, const FVector4& y, TReal t);
    ...
    NW_API FMatrix4 rotateAxis(const FMatrix4& m, const FVector3& axis, const TReal angle);
    ...
    template<class T>
    constexpr TReal* valueptr(const T& o) {
        return *reinterpret_cast<TReal**>((T*)&o);
    }
