...
namespace Neowise {
    ...
    FVector4::FVector4(TReal o) {
        _mm = _mm_set1_ps(o);
    }

    FVector4::FVector4(TReal x, TReal y, TReal z, TReal w) {
        _mm = _mm_set_ps(w, z, y, x);
    }

    FVector4::FVector4(const FVector3& xyz, TReal w) {
        _mm = _mm_set_ps(w, xyz[2], xyz[1], xyz[0]);
    }

    FVector4::FVector4(TReal x, const FVector3& yzw) {
    ...
    TBool FVector4::operator==(const FVector4& r) const {
    ...
    FVector4& FVector4::operator+=(TReal r) {
    ...
    FVector4 FVector4::operator+(TReal r) const {
        return FVector4(*this) += r;
    }
    ...
    TReal& FVector4::operator[](TInt32 i) {
        return _data[i];
    }

    TReal FVector4::operator[](TInt32 i) const {
        return _data[i];
    }

    FVector4 operator+(const TReal a, const FVector4& b) {
        return FVector4(a) + b;
    }
