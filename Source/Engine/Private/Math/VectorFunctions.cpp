...
namespace Neowise {
    ...
    static FVector2 recallfn(const FVector2& v, TReal(*fn)(TReal)) {
        return {
            fn(v[0]),
            fn(v[1])
        };
    }
    static FVector2 recallfn(const FVector2& v1, const FVector2& v2, TReal(*fn)(TReal, TReal)) {
        return {
            fn(v1[0], v2[0]),
            fn(v1[1], v2[1])
        };
    }
    static FVector3 recallfn(const FVector3& v, TReal(*fn)(TReal)) {
        return {
            fn(v[0]),
            fn(v[1]),
            fn(v[2])
    ...
    static FVector3 recallfn(const FVector3& v1, const FVector3& v2, TReal(*fn)(TReal, TReal)) {
        return {
            fn(v1[0], v2[0]),
            fn(v1[1], v2[1]),
            fn(v1[2], v2[2])
    ...
    static FVector4 recallfn(const FVector4& v, TReal(*fn)(TReal)) {
        return {
            fn(v[0]),
            fn(v[1]),
            fn(v[2]),
    ...
    static FVector4 recallfn(const FVector4& v1, const FVector4& v2, TReal(*fn)(TReal, TReal)) {
        return {
            fn(v1[0], v2[0]),
            fn(v1[1], v2[1]),
            fn(v1[2], v2[2]),
    ...
    TReal dot(const FVector2& x, const FVector2& y) {
        const auto t(x * y);
        return t.x + t.y;
    }
    ...
    FVector2 mix(const FVector2& x, const FVector2& y, TReal t) {
        return {
            mix(x[0], y[0], t),
            mix(x[1], y[1], t)
        };
    ...
    TReal dot(const FVector3& x, const FVector3& y) {
        const auto t(x * y);
        return t.x + t.y + t.z;
    }
    ...
    FVector3 mix(const FVector3& x, const FVector3& y, TReal t) {
        return {
            mix(x[0], y[0], t),
            mix(x[1], y[1], t),
            mix(x[2], y[2], t)
    ...
    TReal dot(const FVector4& x, const FVector4& y) {
        const auto t(x * y);
    ...
    FVector4 mix(const FVector4& x, const FVector4& y, TReal t) {
        return {
            mix(x[0], y[0], t),
            mix(x[1], y[1], t),
            mix(x[2], y[2], t),
    ...
    FVector2 normalize(const FVector2& v) {
        return v * rsqrt(dot(v, v));
    }

    FVector3 normalize(const FVector3& v) {
        return v * rsqrt(dot(v, v));
    }

    FVector4 normalize(const FVector4& v) {
        return v * rsqrt(dot(v, v));
    }
