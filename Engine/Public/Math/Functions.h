...
namespace Neowise {
	...
	NW_API FVector2 dot(const FVector2& x, const FVector2& y);
	...
	NW_API FVector3 dot(const FVector3& x, const FVector3& y);
	...
	NW_API FVector4 dot(const FVector4& x, const FVector4& y);
